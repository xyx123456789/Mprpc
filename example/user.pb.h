...
class RegiterRequest;
class RegiterRequestDefaultTypeInternal;
extern RegiterRequestDefaultTypeInternal _RegiterRequest_default_instance_;
class ResultCode;
...
template<> ::fixbug::RegiterRequest* Arena::CreateMaybeMessage<::fixbug::RegiterRequest>(Arena*);
...
class RegiterRequest :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.RegiterRequest) */ {
 public:
  RegiterRequest();
  virtual ~RegiterRequest();

  RegiterRequest(const RegiterRequest& from);
  RegiterRequest(RegiterRequest&& from) noexcept
    : RegiterRequest() {
    *this = ::std::move(from);
  }

  inline RegiterRequest& operator=(const RegiterRequest& from) {
    CopyFrom(from);
    return *this;
  }
  inline RegiterRequest& operator=(RegiterRequest&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const RegiterRequest& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const RegiterRequest* internal_default_instance() {
    return reinterpret_cast<const RegiterRequest*>(
               &_RegiterRequest_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    3;

  friend void swap(RegiterRequest& a, RegiterRequest& b) {
    a.Swap(&b);
  }
  inline void Swap(RegiterRequest* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline RegiterRequest* New() const final {
    return CreateMaybeMessage<RegiterRequest>(nullptr);
  }

  RegiterRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<RegiterRequest>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const RegiterRequest& from);
  void MergeFrom(const RegiterRequest& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(RegiterRequest* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.RegiterRequest";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  // @@protoc_insertion_point(class_scope:fixbug.RegiterRequest)
 private:
  class _Internal;
...
// uint32 id = 1;
inline void RegiterRequest::clear_id() {
  id_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 RegiterRequest::_internal_id() const {
  return id_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 RegiterRequest::id() const {
  // @@protoc_insertion_point(field_get:fixbug.RegiterRequest.id)
  return _internal_id();
}
inline void RegiterRequest::_internal_set_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  id_ = value;
}
inline void RegiterRequest::set_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_id(value);
  // @@protoc_insertion_point(field_set:fixbug.RegiterRequest.id)
}

// bytes name = 2;
inline void RegiterRequest::clear_name() {
  name_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& RegiterRequest::name() const {
  // @@protoc_insertion_point(field_get:fixbug.RegiterRequest.name)
  return _internal_name();
}
inline void RegiterRequest::set_name(const std::string& value) {
  _internal_set_name(value);
  // @@protoc_insertion_point(field_set:fixbug.RegiterRequest.name)
}
inline std::string* RegiterRequest::mutable_name() {
  // @@protoc_insertion_point(field_mutable:fixbug.RegiterRequest.name)
  return _internal_mutable_name();
}
inline const std::string& RegiterRequest::_internal_name() const {
  return name_.GetNoArena();
}
inline void RegiterRequest::_internal_set_name(const std::string& value) {
  
  name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void RegiterRequest::set_name(std::string&& value) {
  
  name_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:fixbug.RegiterRequest.name)
}
inline void RegiterRequest::set_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:fixbug.RegiterRequest.name)
}
inline void RegiterRequest::set_name(const void* value, size_t size) {
  
  name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:fixbug.RegiterRequest.name)
}
inline std::string* RegiterRequest::_internal_mutable_name() {
  
  return name_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* RegiterRequest::release_name() {
  // @@protoc_insertion_point(field_release:fixbug.RegiterRequest.name)
  
  return name_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void RegiterRequest::set_allocated_name(std::string* name) {
  if (name != nullptr) {
  ...
  name_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), name);
  // @@protoc_insertion_point(field_set_allocated:fixbug.RegiterRequest.name)
}

// bytes pwd = 3;
inline void RegiterRequest::clear_pwd() {
  pwd_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& RegiterRequest::pwd() const {
  // @@protoc_insertion_point(field_get:fixbug.RegiterRequest.pwd)
  return _internal_pwd();
}
inline void RegiterRequest::set_pwd(const std::string& value) {
  _internal_set_pwd(value);
  // @@protoc_insertion_point(field_set:fixbug.RegiterRequest.pwd)
}
inline std::string* RegiterRequest::mutable_pwd() {
  // @@protoc_insertion_point(field_mutable:fixbug.RegiterRequest.pwd)
  return _internal_mutable_pwd();
}
inline const std::string& RegiterRequest::_internal_pwd() const {
  return pwd_.GetNoArena();
}
inline void RegiterRequest::_internal_set_pwd(const std::string& value) {
  
  pwd_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void RegiterRequest::set_pwd(std::string&& value) {
  
  pwd_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:fixbug.RegiterRequest.pwd)
}
inline void RegiterRequest::set_pwd(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  pwd_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:fixbug.RegiterRequest.pwd)
}
inline void RegiterRequest::set_pwd(const void* value, size_t size) {
  
  pwd_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:fixbug.RegiterRequest.pwd)
}
inline std::string* RegiterRequest::_internal_mutable_pwd() {
  
  return pwd_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* RegiterRequest::release_pwd() {
  // @@protoc_insertion_point(field_release:fixbug.RegiterRequest.pwd)
  
  return pwd_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void RegiterRequest::set_allocated_pwd(std::string* pwd) {
  if (pwd != nullptr) {
  ...
  pwd_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), pwd);
  // @@protoc_insertion_point(field_set_allocated:fixbug.RegiterRequest.pwd)
}
